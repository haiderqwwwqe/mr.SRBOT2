...
ws[1] = "هلو" -- msg 
rs[1] = "  @roroc1  هلاوووات عيني نورتـ/ي نورني بقناتي فديتك  😻🙈 " -- reply
...
ws[4] = "حيدر" -- msg
rs[4] = "  @haiderqwwq  فديته الحزين منور هاذ المطور مالي" -- reply
...
ws[7] = "مرحبا" -- msg
rs[7] = "@roroc1 مـراحـب😻يـمه هله😻    نورني بقناتي فديتك" -- reply
...
ws[20] = "بنين" -- msg
rs[20] = "ُِـৡـٌٍ💗ـبِّـৡـٌِيّّبة المدير حيدر  يعني رئيسة جمهوريه الكروبالمدير يعشقها عشق 😘 فدوة لطولها 💋😍❤️🌹" -- reply
...
ws[29] = "هاي" -- msg
rs[29] = " @roroc1  هـايـات حيـاتي😻😘" -- reply
...
ws[33] = "هلوو" -- msg
rs[33] = "@roroc1  هلاوات كـبد عمري😍😚" -- reply
